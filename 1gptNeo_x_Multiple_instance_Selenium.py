...
name='hist'
fileA=f'''C:\\Users\\jellycat\\.spyder-py3\\selenium_INPUT_FILES\\{name}.txt'''

f = open(f"{fileA}", "r", encoding='utf-8')
prompt=f.read()
...
def funco():
    ...
    d=str("5.172.24.68,14.177.236.212,105.27.245.253,68.183.129.76,91.202.240.208,162.159.242.100,162.159.242.65,162.159.242.158,162.159.247.92")
...
# select by value 
    ...
    #selenium_OUTPUT
    output_name="selenium_OUTPUT_2"
    f = open(f'''C:\\Users\\jellycat\\.spyder-py3\\selenium_OUTPUT\\{output_name}.txt''', "a", encoding='utf-8')
    f.write('\n\n=---------X-----------=\n\n' + xfvsa)
    f.close()
